...
elseif ($_REQUEST['act'] == 'edit')
{
	...
	/* 代码修改_start By thunje#URLdf */
    $sql = "SELECT cat_id, cat_name, cat_type, cat_desc, show_in_nav, keywords, parent_id,sort_order, define_url FROM ".
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    if ($exc->edit("cat_name = '$_POST[cat_name]', cat_desc ='$_POST[cat_desc]', keywords='$_POST[keywords]',parent_id = '$_POST[parent_id]', cat_type='$cat_type', sort_order='$_POST[sort_order]', show_in_nav = '$_POST[show_in_nav]', define_url='$_POST[define_url]' ",  $_POST['id']))
    {
